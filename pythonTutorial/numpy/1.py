...
# Creating a numpy array. Easiest way is to use np.array() function which takes a sequence like object (like list, set, list of list etc)
...
print ('DataType', arr2d.dtype) # the data type of the data held. we have many datatypes like np.int8/16/32/64, float16/32, string_, bool, unicode_, python object etc.
