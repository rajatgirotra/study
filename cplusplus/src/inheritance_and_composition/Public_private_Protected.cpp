...
[[maybe_unused]] Base objBase;
[[maybe_unused]] Derv objDerv;
...
1] All the private member functions and member data in Base class remain in the base class. They can not be accessed in main. Also, they can not be accessed in member functions of the derived class. They can only be accessed by member functions of the base class.
2] All the public member functions and member data in the Base class become public in the Derived class. They can be accessed in main. Alsothey can be accessed by all member functions in the derived class.
3] All the  protected member functions and member data in the Base class become protected in the Derived class. They cannot be accessed in main; but can be accessed anywhere in the Derived class. (Still to see if they can be accessed by a next level of subclass. Answer is Yes)
