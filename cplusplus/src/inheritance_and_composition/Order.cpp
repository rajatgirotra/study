...
class Derived1 : public Base1 {
  ...
  Member1 m1;
public:
//  Derived1(int) : m1(1), m2(2), Base1(3) { // good option to enable -Werror=reorder to get compile time error to catch this.
  Derived1(int) : Base1(3), m2(2), m1(1)  { // good option to enable -Werror=reorder to get compile time error to catch this.
