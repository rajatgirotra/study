 ...
 *
 * 2) Since C++20, a new operator <=> is introduced, which can performs comparisons <, <=, >, >=. this spaceship operator doesnt return a boolean.
 ...
 *    };
 *    So just by declaring the default spaceship operator, you get all 6 comparison operator. If you instead have your own implementation of spaceship opertaor, then you
 *    must define the == opertaor also.
 *
 *    class Value {
 *       int m_val;
 *    public:
