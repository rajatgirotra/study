/*
 * c++17 allows to capture *this in the lambda introducer []. Before c++17, you could capture only the this pointer by value[=] or by reference [&]
...
int main() {
    auto f1 = Baz{"ala"}.foo(); // temporary Baz object destroyed after this line but we access it in the next line
    f1();
}
