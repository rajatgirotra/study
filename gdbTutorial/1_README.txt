...
-cd <directory>: start gdb from the given directory, instead of from the current directory.
...
4) Run any command specified using the -ix and -eix options. If you want to disable auto-loading, do it here.
