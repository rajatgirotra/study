/* Please read README.txt first. Here we will create a simple client which reads the current
 * time of the day using the daytime server running on port 13. If this service is not running
 * on your system, you'll need to install xinetd first and make a minor change. Then run
 * "telnet localhost 13" to see if it returns you the time of the day. 
 */

//Remember this list of header files which are typically used in network programming. 
#include <iostream>
#include <string>
#include <cstring>
...
int main(int argc, char* argv[]) 
{
    ...
    n = inet_pton(AF_INET, argv[1], &serverAddr.sin_addr);
...
/*
 * Please read simpleTimeOfDayClientIPv6.cpp next
 */
