...
/*
A constant is treated as an integer, then long, then float, then double.
A char gets promoted to an int, then long, then float, then double.
A short gets promoted to an int, then integer, then long, then float, then double.
A byte gets promoted to an short, then int, long, float & then double.
*/
