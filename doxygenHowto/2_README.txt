...
EXCLUDE = 
EXCLIDE_PATTERNS = */test*/ (to ignore all test directories)
...
HTML_DIRECTORY = <relative path to output_directory above where html output is generated>
 ...
 REPEAT_BRIEF=NO // by default the brief description line is also repeated as the first line in the detailed description.
 Setting it to NO will avoid it getting repeated.
